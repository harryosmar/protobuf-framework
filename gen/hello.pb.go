...
// HelloRequest is the request message for GetHello
...
// HelloResponse is the response message for GetHello
...
const file_hello_proto_rawDesc = "" +
	...
	"\fHelloService\x12O\n" +
	"\bGetHello\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/hello/{name}B-Z+github.com/harryosmar/protobuf-go/gen/hellob\x06proto3"
