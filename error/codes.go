...
// G: Identifier for protobuf-go service. For this, i.e., G for General error
...
var (
	codeErrMap = map[CodeErr]CodeErrEntity{
		...
		ErrInvalidArgument:     {Code: "ERR400P03", Status: http.StatusBadRequest, GrpcCode: codes.InvalidArgument, Message: "invalid argument %s"},
		...
		ErrRecordAlreadyExists: {Code: "ERR409P17", Status: http.StatusConflict, GrpcCode: codes.AlreadyExists, Message: "record already exists %s"},
	}
)

// Error code constants
const (
	ErrInternalServer      CodeErr = "ErrInternalServer"
	ErrCancelled           CodeErr = "ErrCancelled"
	ErrUnknown             CodeErr = "ErrUnknown"
	ErrInvalidArgument     CodeErr = "ErrInvalidArgument"
	ErrDeadlineExceeded    CodeErr = "ErrDeadlineExceeded"
	ErrNotFound            CodeErr = "ErrNotFound"
	ErrAlreadyExists       CodeErr = "ErrAlreadyExists"
	ErrPermissionDenied    CodeErr = "ErrPermissionDenied"
	ErrResourceExhausted   CodeErr = "ErrResourceExhausted"
	ErrFailedPrecondition  CodeErr = "ErrFailedPrecondition"
	ErrAborted             CodeErr = "ErrAborted"
	ErrOutOfRange          CodeErr = "ErrOutOfRange"
	ErrUnimplemented       CodeErr = "ErrUnimplemented"
	ErrUnavailable         CodeErr = "ErrUnavailable"
	ErrDataLoss            CodeErr = "ErrDataLoss"
	ErrUnauthenticated     CodeErr = "ErrUnauthenticated"
	ErrRecordAlreadyExists CodeErr = "ErrRecordAlreadyExists"
)
